            ...
            <div className="mt-6 flex flex-col items-center space-y-4">
                ...
                <div>
                    {relations.prev_page_url ? (
                        <Link href={relations.prev_page_url} className="rounded-lg bg-indigo-500 px-4 py-2 text-white transition hover:bg-indigo-600">
                            ← Prev
                        </Link>
                    ) : (
                ...
                <div>
                    {relations.next_page_url ? (
                        <Link href={relations.next_page_url} className="rounded-lg bg-indigo-500 px-4 py-2 text-white transition hover:bg-indigo-600">
                            Next →
                        </Link>
                    ) : (
            ...
            {showModal && (
                <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black backdrop-blur-sm">
                    <div className="relative z-60 w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
                        ...
                        <button onClick={generateCode} className="mt-2 rounded-md bg-indigo-600 px-4 py-2 text-white transition hover:bg-indigo-700">
                            Generate Code
                        </button>
